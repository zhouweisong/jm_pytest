...
class Home_Page(BasePage):
    ...
    def touch_home_newsfeed(self):
        self.find_element(By.ID,self.home_newsfeed).click()

    def touch_home_friend(self):
        self.find_element(By.ID,self.home_friend).click()

    def touch_home_rss(self):
        self.find_element(By.ID,self.home_rss).click()

    def touch_home_message(self):
        self.find_element(By.ID,self.home_message).click()

    def touch_home_profile(self):
        self.find_element(By.ID,self.home_profile).click()
